...
lab1.exe 4.1 5.1 4.1 > tests\out.txt
IF ERRORLEVEL 1 GOTO err
FC /B tests\out.txt tests\isosceles_triangle.txt
IF ERRORLEVEL 1 GOTO err

REM running program where all sides are equale
lab1.exe 3.1 3.1 3.1 > tests\out.txt
IF ERRORLEVEL 1 GOTO err
